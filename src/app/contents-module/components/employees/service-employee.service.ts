...
// -------------creacion de usuario---------------
  CreateUser(formUsers, formUserExtendEmployee, formPermissions): Observable<any> {
    ...
    return this.http.post(GlobalConstants.URL_EXTEND_USER_EMPLOYEE + '/create', {
...
// -----------------busqueda permisos y cargos---------------
  SearchPermissionAndPositions(): Observable<any> {
    return this.http.get(GlobalConstants.URL_USER + '/viewPermissionAndPosition', this.httpOptions);
  }
...
// ---------------- visualizar un usuario con sus respectivos permisos---------
  SearchOneUser(userId): Observable<any> {
    return this.http.post(GlobalConstants.URL_EXTEND_USER_EMPLOYEE + '/viewOne', {
      id: userId
    }, this.httpOptions );
  }
...
// ------------------------desactivar funcionario registrado------------------
  Deactive(userId): Observable<any> {
    return this.http.post(GlobalConstants.URL_USER + '/deactivate', {
      id: userId
    }, this.httpOptions);
  }
// ---------------------fin desactivar funcionario resgistrado-----------------------
 ...
 UpdateUserAndPermissions(dataUser, dataExtenssion, permission): Observable<any> {
  return this.http.post(GlobalConstants.URL_EXTEND_USER_EMPLOYEE + '/update', {
    user: dataUser,
